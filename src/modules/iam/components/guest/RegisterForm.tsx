...
import { UserPlus, Mail, Lock, User, Gift, Loader2, ArrowRight, Check } from "lucide-react";
    ...
    <Card className="w-full max-w-md border-border/80 bg-card/90 shadow-2xl rounded-3xl overflow-hidden backdrop-blur-md">
      <CardHeader className="text-center pt-8 pb-4 space-y-2">
        ...
        <CardDescription className="text-xs text-muted-foreground">
          Dapatkan akses instan ke jaringan server VPN berkecepatan tinggi di 30+ negara.
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="p-6 pt-2 space-y-5">
        <form onSubmit={handleSubmit} className="space-y-4">
          {/* Username */}
          <div>
            <Label htmlFor="reg-username" className="text-xs font-medium text-muted-foreground">
              Username
            </Label>
          ...
          {/* Password */}
          <div>
            <Label htmlFor="reg-pw" className="text-xs font-medium text-muted-foreground">
          ...
          <div>
            <Label htmlFor="reg-ref" className="text-xs font-medium text-muted-foreground">
          ...
          <Button
            type="submit"
            disabled={isSubmitting || !username.trim() || !email.trim() || !hasMinLength}
