...
import { DnsAccount, DnsDomain, DnsRecord } from "../types/dns.types";
import {
...
export const dnsAdminApi = {
  ...
  createAccount: (
    data: AdminCreateDnsAccountDto,
  ): Promise<ApiResponse<DnsAccount>> =>
  ...
  createDomain: (
    data: AdminCreateDnsDomainDto,
  ): Promise<ApiResponse<DnsDomain>> =>
  ...
  updateRecord: (
    id: string | number,
    data: Partial<AdminCreateDnsRecordDto>,
  ): Promise<ApiResponse<DnsRecord>> =>
