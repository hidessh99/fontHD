...
import { CreateSellerServerDto, UpdateSellerServerDto } from "../types/seller.types";

export const vpnSellerApi = {
  // === RESELLER SERVERS: ALWAYS (4 Endpoints) ===
  // 1. POST /api/seller/vpn/servers/always
  createAlwaysServer: (data: CreateSellerServerDto, idempotencyKey?: string): Promise<ApiResponse<ServerNode>> =>
    apiClient.post<ServerNode>("/api/seller/vpn/servers/always", data, { idempotencyKey }),
  ...
  updateAlwaysServer: (id: number | string, data: UpdateSellerServerDto): Promise<ApiResponse<ServerNode>> =>
  ...
  deleteAlwaysServer: (id: number | string): Promise<ApiResponse<{ deleted: boolean }>> =>
    apiClient.delete<{ deleted: boolean }>(`/api/seller/vpn/servers/always/${id}`),

  // === RESELLER SERVERS: MONTH (4 Endpoints) ===
  // 5. POST /api/seller/vpn/servers/month
  createMonthServer: (data: CreateSellerServerDto, idempotencyKey?: string): Promise<ApiResponse<ServerNode>> =>
    apiClient.post<ServerNode>("/api/seller/vpn/servers/month", data, { idempotencyKey }),
  ...
  updateMonthServer: (id: number | string, data: UpdateSellerServerDto): Promise<ApiResponse<ServerNode>> =>
  ...
  deleteMonthServer: (id: number | string): Promise<ApiResponse<{ deleted: boolean }>> =>
    apiClient.delete<{ deleted: boolean }>(`/api/seller/vpn/servers/month/${id}`),

  // === RESELLER SERVERS: PAYAS (4 Endpoints) ===
  // 9. POST /api/seller/vpn/servers/payas
  createPayasServer: (data: CreateSellerServerDto, idempotencyKey?: string): Promise<ApiResponse<ServerNode>> =>
    apiClient.post<ServerNode>("/api/seller/vpn/servers/payas", data, { idempotencyKey }),
  ...
  updatePayasServer: (id: number | string, data: UpdateSellerServerDto): Promise<ApiResponse<ServerNode>> =>
  ...
  deletePayasServer: (id: number | string): Promise<ApiResponse<{ deleted: boolean }>> =>
    apiClient.delete<{ deleted: boolean }>(`/api/seller/vpn/servers/payas/${id}`),
};
