...
export const financeAdminApi = {
  ...
  updateBilling: (
    id: string | number,
    data: Partial<AdminCreateBillingDto>,
  ): Promise<ApiResponse<BillingRecord>> =>
  ...
  updateInvoice: (
    id: string | number,
    data: Partial<AdminCreateInvoiceDto>,
  ): Promise<ApiResponse<Invoice>> =>
  ...
  updateVoucher: (
    id: string | number,
    data: Partial<AdminCreateVoucherDto>,
  ...
  updateWithdrawalStatus: (
    ...
    apiClient.patch<WithdrawalRecord>("/api/admin/withdrawal/status", {
      id,
      ...data,
    }),
};
