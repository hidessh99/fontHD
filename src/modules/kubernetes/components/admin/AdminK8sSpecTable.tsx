...
// 100% Coinbase Institutional Design System (Resource Tiers & Pricing)
// ==============================================================================
...
import { Layers, Plus, Trash2, Loader2, Coins } from "lucide-react";
  ...
  return (
    <div className="space-y-4">
      ...
      {specs.length === 0 ? (
        <EmptyState
          icon={Layers}
          title="Belum Ada Paket Spec"
          description="Tambahkan paket spec pertama Anda untuk menentukan kuota dan harga container pod."
        />
      ) : (
        <div className="w-full overflow-x-auto rounded-2xl border border-border/80 bg-card/60 shadow-xl">
          <table className="w-full text-left text-sm text-muted-foreground font-mono">
            <thead className="border-b border-border/80 bg-muted/30 text-xs font-semibold uppercase tracking-wider text-muted-foreground">
              <tr>
                <th className="px-5 py-4 font-sans">Nama Spec</th>
                <th className="px-5 py-4 font-sans">vCPU</th>
                <th className="px-5 py-4 font-sans">RAM</th>
                <th className="px-5 py-4 font-sans">Storage</th>
                <th className="px-5 py-4 font-sans">Tarif Bulanan</th>
