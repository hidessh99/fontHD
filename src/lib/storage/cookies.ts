// ==============================================================================
// GoVPN Client Cookie Storage Utility
// Manages session cookies synchronized with Next.js Edge Middleware & Go backendv2
// ==============================================================================
...
export function deleteCookie(name: string) {
  if (typeof document === "undefined") return;
  // Use explicit 1970 expiration date and Max-Age=0 to guarantee instant purge
...
export function clearAllAuthStorage() {
  ...
  try {
    localStorage.removeItem("govpn_auth_storage");
